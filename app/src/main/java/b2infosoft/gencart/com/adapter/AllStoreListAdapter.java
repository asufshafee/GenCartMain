...
public class AllStoreListAdapter extends RecyclerView.Adapter<AllStoreListAdapter.MyviewHolder> {
    Context mContext;
    ArrayList<StoreListPojo> mList;


    public AllStoreListAdapter(Context mcontext, ArrayList<StoreListPojo> productlistPojos) {
    ...
    public MyviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View vp = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_all_storelist_item2, parent, false);
        return new MyviewHolder(vp);
    }

    @Override
    public void onBindViewHolder(MyviewHolder holder, int position) {
        //holder.imRat1.setImageResource(R.drawable.with_fill);
